    ...
    <script>
        $(document).ready(function () {
            $('#same_as_present').click(function (event) {
                if (this.checked) {
                    $('.permanent_address_disable').addClass('custom_disable');
                } else {
                    $('.permanent_address_disable').removeClass('custom_disable');
                }
            })
        ...
        $(document).ready(function () {
            $('input:radio[name="marital_status"]').change(function () {
                if ($(this).is(':checked') && $(this).val() == 'Married') {
                    $(".after_spouse_name_field_append").after(`
                    <div class="col-5 spouse_name_remove">
                        <input class="form-control form-control-sm spouse_name" type="text" name="spouse_name" placeholder="Spouse Name">
                    </div>
                `)
                } else {
                    $('.spouse_name_remove').remove()
                }
            });
        })
    </script>
    ...
    <script>
        ...
        $(".addNewProfession").on('click', function () {
            ...
            $(".appendNewProfession").append('<div id="experienceInfo" class="info mt-2 singleExperienceRow">\n' +
                ...
                '                                  </div>\n' +
                '                              </div>\n' +
                '                                          <input class="experienceRows[]" type="hidden" name="experienceRows[]">\n' +

                '                              <div class="form-group row">\n' +
                '                                  <div class="col-sm-4 col">\n' +
                '                                      <small>\n' +
                '                                          Service Start <span class="float-right start_date">:</span>\n' +
                '                                      </small>\n' +
                '                                  </div>\n' +
                '                                  <div class="col-sm-8">\n' +
